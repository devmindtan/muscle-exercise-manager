...
import { getMuscleGroupsWithWeeklyStats } from '@/lib/repository';
import type { WeekStat } from '@/lib/repository';
          ...
          <>
            ...
            {stats.map((s) => (
              ...
              >
                ...
                <ProgressBar
                  value={s.weekly_sets}
                  target={s.target_sets_per_week}
                  color={s.color}
                />
                {s.target_sets_per_week > s.weekly_sets && (
                  <Text style={styles.remaining}>
                    Còn {s.target_sets_per_week - s.weekly_sets} sets
                  </Text>
                )}
                {s.progress >= 1 && (
