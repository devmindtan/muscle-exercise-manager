...
import { persistImageLocally } from '@/lib/image';
import { getMuscleGroups, insertMuscleGroup } from '@/lib/repository';
  ...
  const save = async () => {
    ...
    try {
      await insertMuscleGroup({
        name: form.name.trim(),
        color: form.color,
        target_sets_per_week: parseInt(form.target_sets_per_week) || 10,
        target_sets_per_month: parseInt(form.target_sets_per_month) || 40,
